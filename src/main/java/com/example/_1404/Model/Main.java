...
public class Main {
    ...
    public static Department getDepartmentById(int id) {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/company", "inai1", "12345678");
                        ...
                        switch (departmentoperation) {
                            case 1:
                                ...
                                try {
                                    ...
                                    Class.forName("com.mysql.jdbc.Driver");
                                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost/company", "inai1",
                                            "12345678");
